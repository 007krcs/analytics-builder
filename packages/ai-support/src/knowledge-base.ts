...
export const KNOWLEDGE_BASE: KbEntry[] = [
...

  {
    ...
    answer: `Analytix provides a **Vue 3 adapter** (\`@analytix/vue\`) with composables:\n\n**Install:**\n\`\`\`bash\nnpm install @analytix/vue @analytix/core vue\n\`\`\`\n\n**Composables:**\n\`\`\`js\nimport { useAnalyticsEngine, useKpi, usePivot } from '@analytix/vue';\n\nexport default {\n  setup() {\n    const { engine } = useAnalyticsEngine();\n    const kpiResult = useKpi(engine, kpiConfig);\n    const pivotResult = usePivot(engine, pivotConfig);\n    return { engine, kpiResult, pivotResult };\n  }\n};\n\`\`\`\n\n**Note:** The Vue adapter is currently in **beta**. The core engine (\`@analytix/core\`) works framework-agnostic — you can use it with Vue's reactive system directly.\n\nFull Vue component library coming in v2.0.`,
...

  {
    ...
    answer: `Analytix uses an **open-core model**:\n\n🔓 **Open Source (MIT License)**\n• \`@analytix/core\` — engine, types, store\n• \`@analytix/chart-engine\` — all 26 chart transformers\n• \`@analytix/pivot-engine\` — pivot computation\n• \`@analytix/react\` — React components\n• \`@analytix/kpi-engine\` — KPI computation\n• \`@analytix/insight-engine\` — AI insights\n\n🔐 **Commercial (enterprise license)**\n• Real-time collaboration (Yjs CRDT)\n• PDF report designer\n• Delta Lake / Parquet connector\n• White-label licensing\n\n**GitHub:** github.com/007krcs/analytics-builder\n\n**Contributing:**\n1. Fork the repository\n2. Create a feature branch\n3. Submit a Pull Request\n\nWe welcome contributions! See CONTRIBUTING.md for guidelines.`,
