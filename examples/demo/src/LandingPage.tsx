      ...
      <section className="lp-hero" id="top">
        ...
        <div className="lp-container lp-hero__inner">
          ...
          <p className="lp-hero__legal">
            13 npm packages · 300+ automated tests · 100% TypeScript · No data leaves the browser.
          </p>
      ...
      <section className="lp-section lp-outcomes">
        <div className="lp-container">
          ...
          <div className="lp-outcomes__grid">
            ...
            <OutcomeCard value="300+" label="automated tests"    sub="Run pnpm test to count them all passing" />
          </div>
        </div>
      </section>
